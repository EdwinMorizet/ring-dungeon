...
const GRAVITY_TRAIT_MARKER_KEY: StringName = &"gravity_trait_enabled"
const GRAVITY_TRAIT_PROFILE_GRAVITY_INFLUENCE: float = 3.0
const GRAVITY_TRAIT_PROFILE_LINEAR_DAMP: float = 0.14
const GRAVITY_TRAIT_PROFILE_ANGULAR_DAMP: float = 0.0
